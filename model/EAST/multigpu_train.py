...
tf.app.flags.DEFINE_integer('batch_size_per_gpu', 2, '')  #一次读入几张
tf.app.flags.DEFINE_integer('num_readers', 1, '')
tf.app.flags.DEFINE_float('learning_rate', 0.0001, '')
tf.app.flags.DEFINE_integer('max_steps', 150000, '')
tf.app.flags.DEFINE_float('moving_average_decay', 0.997, '')
tf.app.flags.DEFINE_string('gpu_list', '0', '')  # 用的哪块GPU
tf.app.flags.DEFINE_string('checkpoint_path', 'model/', '') #模型存储的地方
